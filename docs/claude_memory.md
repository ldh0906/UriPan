...
2. ~~**코멘트/가벼운 소통**~~ ← **현재 착수 (대회의 2026-06-02 결정)**. 설계: `docs/superpowers/specs/2026-06-02-item-comments-design.md`, 실행 큐: `docs/codex-tasks/` 01~04. 결정: 스레드 실시간 / 코멘트 수 배지 비실시간(C안) / 첫 스키마 변경(item_comments) / FCM은 Phase B. 코멘트 이후 = UI/UX 폴리시.
